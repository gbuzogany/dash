...
def dash_repositories():
    ...
    #     http_archive,
    #     name = "sdl2",
    #     sha256 = "08fb91829a1e6a1aed3213788c88728d23afd387b424903195b7866dabfbb95e",
    #     strip_prefix = "sdl2-bazel-v0.2",
    #     urls = [
    #         "https://github.com/gbuzogany/sdl2/archive/bazel-v0.2.tar.gz"
    #     ]
    # )
